                ...
                <form onSubmit={handleSubmit} className="space-y-5 animate-fadeIn">
                  ...
                  <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1">Driver Name</label><input type="text" maxLength={50} value={driver} onChange={e => setDriver(e.target.value)} className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-900 dark:text-slate-50 text-base shadow-sm" placeholder="Driver Name" required /></div>
                        <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1">Company</label><input type="text" maxLength={50} value={company} onChange={e => setCompany(e.target.value)} className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-900 dark:text-slate-50 text-base shadow-sm" placeholder="Company" required /></div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1 truncate">Bus #</label><input type="text" inputMode="numeric" maxLength={10} value={busNo} onChange={e => setBusNo(e.target.value)} className="w-full px-3 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-900 dark:text-slate-50 text-center font-medium text-base shadow-sm" placeholder="#" required /></div>
                        <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1 truncate">Pax</label><input type="number" inputMode="numeric" maxLength={4} value={passengers} onChange={e => setPassengers(e.target.value)} className="w-full px-3 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-900 dark:text-slate-50 text-center font-medium text-base shadow-sm" placeholder="0" required /></div>
                      </div>
                  </div>
                  <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1">Notes</label><textarea maxLength={500} value={notes} onChange={e => setNotes(e.target.value)} className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none resize-none text-slate-900 dark:text-slate-50 text-base shadow-sm" placeholder="Optional details..." rows={2} /></div>
                ...
                <form onSubmit={handleCheckInSubmit} className="space-y-6 animate-fadeIn">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div><label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide ml-1">Bus #</label><input type="text" inputMode="numeric" maxLength={10} value={busNo} onChange={e => setBusNo(e.target.value)} className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900/50 rounded-xl focus:ring-2 focus:ring-orange-500 outline-none text-slate-900 dark:text-slate-50 text-base" placeholder="#" required /></div>
                      </div>
                  </div>
